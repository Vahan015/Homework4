...
class WeatherViewModel : ViewModel() {
    ...
    val weatherData: LiveData<List<WeatherData>> get() = CityData
    ...
    fun convertTemperature(tempCelsius: Double, isFahrenheit: Boolean): Double {
        return if (isFahrenheit) (tempCelsius * 9 / 5) + 32 else tempCelsius
    }
